...
var parseCases = []parseCase{
	...
	// 2b) 用户 2026-09-22 的真实片名：SP 是"特别篇"语义，**不算正片集号**（保留原规则）；
	// 而标题里的"传108将"以前被当成第 108 集 —— 假集号必须一个都没有。
	{"穿越水浒：从拒绝招安开始-SP01-武松开团宋江，二龙山要走，你梁山能拦得住？ #AI漫剧.mp4", false, nil, nil},
	{"穿越水浒：从拒绝招安开始-SP17-林冲斗杀董平，全程压制！轰天雷炮轰豹子头！ 传108将 #AI生成.mp4", false, nil, nil},

	// 2c) 推荐命名：同一个片名只换集号 token，必须认出来（用户改名的依据）
	{"穿越水浒：从拒绝招安开始-第01集-武松开团宋江，二龙山要走，你梁山能拦得住？ #AI漫剧.mp4", true, nil, intPtr(1)},
	{"穿越水浒：从拒绝招安开始-E01-武松开团宋江，二龙山要走，你梁山能拦得住？ #AI漫剧.mp4", true, nil, intPtr(1)},
	{"穿越水浒：从拒绝招安开始-01-武松开团宋江，二龙山要走，你梁山能拦得住？ #AI漫剧.mp4", true, nil, intPtr(1)},
	{"剧名03集.mp4", true, nil, intPtr(3)},

	// 反例：总集数（全/共）与中文标题里的数字都不是集号
	{"剧名.全24集.mp4", false, nil, nil},
	{"剧名.共24集.mp4", false, nil, nil},
	{"水浒108将.mp4", false, nil, nil},
